...
function createAllButtons()
  --Overview buttons
  touch1:add("Background",setBackground,3,4,19,4,_G.language:getText("wordBackground"),_G.language:getText("wordBackground"))
  touch1:add("Text",setText,3,6,19,6,_G.language:getText("wordText"),_G.language:getText("wordText"))
  touch1:add("Reactor Off",setOffAt,3,8,19,8,_G.language:getText("reactorOff"),_G.language:getText("reactorOff"))
  touch1:add("Reactor On",setOnAt,3,10,19,10,_G.language:getText("reactorOn"),_G.language:getText("reactorOn"))
  touch1:add("Turbine Speed",setTurbineSpeed,3,12,19,12,_G.language:getText("turbineSpeed"),_G.language:getText("turbineSpeed"))
  touch1:add("Steam Input",setTurbineSteamRate,3,14,19,14,_G.language:getText("steamInput"),_G.language:getText("steamInput"))
  touch1:add("Turbine On/Off",changeTurbineBehaviour,3,16,19,16,_G.language:getText("turbineOnOff"),_G.language:getText("turbineOnOff"))
  touch1:add("Delete Config",resetConfig,3,18,19,18,_G.language:getText("deleteConfig"),_G.language:getText("deleteConfig"))
  touch1:add("Save",saveConfigFile,3,21,19,21,_G.language:getText("wordSave"),_G.language:getText("wordSave"))
  touch1:add("Main menu",displayMenu,3,23,19,23,_G.language:getText("wordMainMenu"),_G.language:getText("wordMainMenu"))

  --Color buttons
  touch2:add("White",function() setColor(1) end,35,5,48,5,_G.language:getText("wordWhite"),_G.language:getText("wordWhite"))
  touch2:add("Orange",function() setColor(2) end,50,5,63,5,_G.language:getText("wordOrange"),_G.language:getText("wordOrange"))
  touch2:add("Magenta",function() setColor(4) end,35,7,48,7,_G.language:getText("wordMagenta"),_G.language:getText("wordMagenta"))
  touch2:add("Lightblue",function() setColor(8) end,50,7,63,7,_G.language:getText("wordLightBlue"),_G.language:getText("wordLightBlue"))
  touch2:add("Yellow",function() setColor(16) end,35,9,48,9,_G.language:getText("wordYellow"),_G.language:getText("wordYellow"))
  touch2:add("Lime",function() setColor(32) end,50,9,63,9,_G.language:getText("wordLime"),_G.language:getText("wordLime"))
  touch2:add("Pink",function() setColor(64) end,35,11,48,11,_G.language:getText("wordPink"),_G.language:getText("wordPink"))
  touch2:add("Gray",function() setColor(128) end,50,11,63,11,_G.language:getText("wordGray"),_G.language:getText("wordGray"))
  touch2:add("Lightgray",function() setColor(256) end,35,13,48,13,_G.language:getText("wordLightGray"),_G.language:getText("wordLightGray"))
  touch2:add("Cyan",function() setColor(512) end,50,13,63,13,_G.language:getText("wordCyan"),_G.language:getText("wordCyan"))
  touch2:add("Purple",function() setColor(1024) end,35,15,48,15,_G.language:getText("wordPurple"),_G.language:getText("wordPurple"))
  touch2:add("Blue",function() setColor(2048) end,50,15,63,15,_G.language:getText("wordBlue"),_G.language:getText("wordBlue"))
  touch2:add("Brown",function() setColor(4096) end,35,17,48,17,_G.language:getText("wordBrown"),_G.language:getText("wordBrown"))
  touch2:add("Green",function() setColor(8192) end,50,17,63,17,_G.language:getText("wordGreen"),_G.language:getText("wordGreen"))
  touch2:add("Red",function() setColor(16384) end,35,19,48,19,_G.language:getText("wordBlack"),_G.language:getText("wordBlack"))
  touch2:add("Black",function() setColor(32768) end,50,19,63,19,_G.language:getText("wordBack"),_G.language:getText("wordBack"))
  ...
  touch3:add("Back",backToMainMenu,3,13,19,13,_G.language:getText("wordBack"),_G.language:getText("wordBack"))
  ...
  touch4:add("Back",backToMainMenu,3,13,19,13,_G.language:getText("wordBack"),_G.language:getText("wordBack"))
end
